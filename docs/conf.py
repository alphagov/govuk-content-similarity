# govuk-content-similarity documentation build configuration file
#
...
project = "govuk-content-similarity"
...
htmlhelp_basename = "govuk-content-similaritydoc"
...
latex_documents = [
    ("index",
     "govuk-content-similarity.tex",
     u"govuk-content-similarity Documentation",
     u"Your Name/Organisation", "manual"),
]
...
man_pages = [
    ("index", "govuk-content-similarity", u"govuk-content-similarity Documentation",
     [u"Your Name/Organisation"], 1)
]
...
texinfo_documents = [
    ("index", "govuk-content-similarity", u"govuk-content-similarity Documentation",
     u"Your Name/Organisation", "govuk-content-similarity",
     "Project using embeddings to find similar GOV.UK content to a piece of text or content item.", "Miscellaneous"),
]
